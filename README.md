...
[![Watch the video](https://img.youtube.com/vi/0mfLdoRZOFE/0.jpg)](https://www.youtube.com/watch?v=0mfLdoRZOFE)
...
- 多層級計畫管理： 主計畫與子計畫 CRUD 功能，同時支援主計畫與無限擴充的子計畫關聯，清晰呈現進度脈絡。

- 進度連動邏輯： 子計畫狀態改變時，後端自動重新加權計算主計畫之進度狀態，確保數據準確。

- 連動刪除機制： 採用 SQL Transaction 確保主計畫與旗下所有子計畫的刪除操作確實完成。

- 搜尋與篩選功能： 整合關鍵字搜尋與計畫狀態過濾。

- 視覺化進度追蹤： 包含自動化日期倒數、進度條樣式設計。

- 表單驗證機制： 實作表單驗證邏輯，確保資料的完整性並提升使用者互動體驗。
